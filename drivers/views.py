...
from .forms import BookingForm, ReviewForm, ContactForm  # Added ContactForm import
...
def home(request):
    ...
    contact_form = ContactForm()  # Added this line
    ...
    if form.is_valid():
        ...
        send_mail(
            ...
            message=(
                ...
                f"Phone: {booking.phone}\n"  # <-- Reads from the saved model instance
                f"Date: {booking.date}\n"
                f"Time: {booking.time}\n"
...
# this is the contract form view function
def contact(request):
    if request.method != 'POST':
        return redirect('drivers:home')
    ...
    if form.is_valid():
        ...
        send_mail(
            ...
            message=(
                ...
                f"Number: {contact_msg.number}\n"  #I did not add number in the form but you can add it if you want
                f"Message:\n{contact_msg.message}"
            ),
            from_email=settings.EMAIL_HOST_USER,
            recipient_list=['mdmahufuzmahi@gmail.com'],
